"""
Test Simple ML-Only pipeline to ensure it uses trained models exclusively.
"""
...
def test_simple_ml_only_pipeline():
    """Test Simple ML-only pipeline with deleterious mutations."""
    print("🧬 Testing Simple ML-Only Pipeline")
    print("="*60)
    ...
    print(f"Testing {len(test_cases)} mutations with Simple ML-only classifier...\n")
    ...
    # Summary analysis
    print("="*60)
    print("SIMPLE ML-ONLY PIPELINE SUMMARY")
    print("="*60)
    ...
    print(f"Simple ML-Only Accuracy: {accuracy:.1%} ({correct}/{total})")
...
def test_web_interface_simple_ml():
    """Test web interface with Simple ML-only predictions."""
    print("\n" + "="*60)
    print("🌐 WEB INTERFACE SIMPLE ML-ONLY TESTING")
    print("="*60)
    print("The web server is running at: http://127.0.0.1:7860")
    print("\nTest these mutations with Simple ML-only predictions:")
    ...
    print(f"\n🎯 Expected Results with Simple ML-Only:")
...
def main():
    ...
    print("🧬 SIMPLE ML-ONLY PIPELINE TESTING")
    print("="*60)
    
    # Test Simple ML-only pipeline
    results = test_simple_ml_only_pipeline()
    
    # Test web interface instructions
    test_web_interface_simple_ml()
    
    print(f"\n" + "="*60)
    print("✅ SIMPLE ML-ONLY PIPELINE TESTING COMPLETE!")
    print("="*60)
    print("The pipeline now uses ONLY trained ML models")
    print("with no rule-based fallback for maximum accuracy.")
    print("\n🌐 Web interface is ready for Simple ML-only testing at http://127.0.0.1:7860")
    print("\n💡 Key improvements:")
